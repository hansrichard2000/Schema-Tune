...
def parse_file(gold_file, predictions_file):
	...
	output_file = os.path.join('stereoset_result_checkpoint_epoch1_R11.json')
...
def get_scores():
	parse_file(os.path.join('data','stereoset','test.json'),
		os.path.join('results_schematune','stereoset_results.json'))