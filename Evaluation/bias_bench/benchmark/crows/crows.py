...
class CrowSPairsRunner:
    ...
    def _likelihood_score(self):
        ...
        with tqdm(total=total) as pbar:
            for index, data in df_data.iterrows():
                ...
                df_score = pd.concat([df_score, pd.DataFrame([temp])], ignore_index=True)
    ...
    def _average_log_probability(self, token_ids, spans):
        ...
        for position in spans:
            ...
            print(self._tokenizer.mask_token_id)
    ...
    def _read_data(self, input_file):
        ...
        with open(input_file) as f:
            ...
            for row in reader:
                ...
                #print(df_data)
                #print(df_item)
                self._tokenizer(sent1, return_tensors="pt", truncation=True)
                self._tokenizer(sent2, return_tensors="pt", truncation=True)
